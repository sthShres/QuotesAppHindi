...
public class Seven extends AppCompatActivity implements View.OnClickListener{
    ...
    TextView count_txt, quuotes_txt;
    CardView back_btn, copy_btn, share_btn, nxt_btn;
    ...
    protected void onPostCreate(@Nullable Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Life Quotes");
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);

        count_txt = findViewById(R.id.countTEXT);
        quuotes_txt = findViewById(R.id.quotesTEXT);
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("lifequotes");
        myShayari = new Model();
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                quuotes_txt.setText(quotes_list.get(position));
    ...
    private void copy(){
        ...
        ClipData clipData = ClipData.newPlainText("text",quuotes_txt.getText());
    ...
    private void share(){
        ...
        whatsappIntent.putExtra(Intent.EXTRA_TEXT, quuotes_txt.getText());
        try {
