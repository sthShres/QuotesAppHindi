...
public class elevan extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onPostCreate(@Nullable Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Dosti Quotes");
        ...
        //data base function
        databaseReference = FirebaseDatabase.getInstance().getReference("dostiquotes");
        myShayari = new Model();
